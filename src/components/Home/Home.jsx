    ...
    <div className="portfolio-container">
      ...
      <div className="container pb-4">
                    ...
                    <div className="col-md-5">
                      <div className="card-content">
                        <div>
                          ...
                          <h3 className="project-title mb-4 fade-in delay-200">LUMORA</h3>
                    ...
                    <div className="col-md-5">
                      <div className="card-content">
                        <div>
                          ...
                          <h3 className="project-title mb-4 fade-in delay-200">Seminar Hall Booking System</h3>
                          <p className="project-description mb-4 fade-in delay-400">
        ...
        <div className="text-center mt-5 mb-5">
          <a href="#" className="view-all-projects fade-in" onClick={()=>{navigate('/work')}}>
