    ...
    <nav className="navbar navbar-dark custom-navbar">
      <div className="container-fluid navbar-container">
        ...
        <div className="navbar-brand-section">
          <a href="/" className="brand-text">Ashish Lukka</a>
        </div>
        ...
        <div className="center-nav">
          ...
          <a className="nav-link desktop-resume" target="_blank" href="https://drive.google.com/file/d/19DOrqBt6M33FIKEJ9PGICzueeEZM6oND/view?usp=sharing">
        ...
        <div className="mobile-nav" ref={mobileNavRef}>
          ...
          {isExpanded && (
            <div className="mobile-menu">
              <a className="mobile-nav-link" target="_blank" href="https://drive.google.com/file/d/19DOrqBt6M33FIKEJ9PGICzueeEZM6oND/view?usp=sharing">
                Resume 
